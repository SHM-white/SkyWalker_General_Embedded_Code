...
#define DJI_MOTOR_DEFINE(inst, profile_symbol)                                                                         \
    ...
    DEVICE_DT_INST_DEFINE(inst, skywalker::motor::dji::internal::djiMotorInit, nullptr, &dji_data_##inst,              \
                          &dji_config_##inst, POST_KERNEL, CONFIG_SKYWALKER_MOTOR_INIT_PRIORITY,                       \
