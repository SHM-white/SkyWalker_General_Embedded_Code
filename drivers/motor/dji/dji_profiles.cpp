...
const Profile kM3508C620Profile = {
    Model::M3508C620, 8u, 0x200u, 0x200u, 0x1FFu, 16384, 20.0f, true, PositionSensorType::RelativeOnly, 8192u,
};

const Profile kM2006C610Profile = {
    Model::M2006C610, 8u, 0x200u, 0x200u, 0x1FFu, 10000, 10.0f, false, PositionSensorType::RelativeOnly, 8192u,
};

const Profile kGM6020CurrentProfile = {
    Model::GM6020Current, 7u, 0x204u, 0x1FEu, 0x2FEu, 16384, 3.0f, true, PositionSensorType::FixedZeroSingleTurn, 8192u,
};
