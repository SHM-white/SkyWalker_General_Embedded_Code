...
inline skywalker::control::VelocityMotor::Config motorConfig() {
    ...
    config.effort_unit = dm ? skywalker::control::EffortUnit::NewtonMeter
                            : skywalker::control::EffortUnit::Ampere;
    config.safety = {12.0f, 70.0f};
    config.loop.regulator.feedback = {.kp = .03f, .ki = .1f, .kd = 0.0f,
                                      .derivative_tau_s = 0.0f, .integral_min = -.3f,
                                      .integral_max = .3f, .output_min = -.3f,
                                      .output_max = .3f, .deadband = 0.0f,
                                      .dt_min_s = .001f, .dt_max_s = .02f};
