...
public:
    struct Stats { std::uint32_t valid_frames=0, crc_errors=0, length_errors=0, version_errors=0, unknown_messages=0, queue_overflows=0, assembly_timeouts=0; };
...
private:
    ...
    std::uint32_t timeout_ms_; Stats stats_{};
};
}
